        ...
        <div className="row gap-lg-0 gap-5">
            <div className="col-lg-6 col-12 my-auto">
                ...
                <h1 className="header-title color-palette-1 fw-bold">
                    Topup & Get <span className="d-sm-inline d-none" /><span className="d-sm-none d-inline">a </span><span className="underline-blue"> New</span> <br className="d-sm-block d-none"/> <span className="underline-blue">Experience</span> in Gaming
                </h1>
