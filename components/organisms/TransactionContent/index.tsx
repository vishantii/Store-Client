        ...
        <div className="row mt-30 mb-20">
          <div className="col-lg-12 col-12 main-content">
            <div id="list_status_title">
              <Tab onClick={() => onTabClick("all")} title="All Trx" active={tab === "all"} />
              <Tab onClick={() => onTabClick("success")} title="Success" active={tab === "success"} />
              <Tab onClick={() => onTabClick("pending")} title="Pending" active={tab === "pending"} />
              <Tab onClick={() => onTabClick("failed")} title="Failed" active={tab === "failed"} />
            </div>
          </div>
        </div>
